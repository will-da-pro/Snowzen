...
public class Skills implements Listener {
	...
	public void onBreak(BlockBreakEvent br) {
		...
		int xp = Main.plugin.getConfig().getInt("players." + player.getName() + ".skills.mining.xp");
		if (block == Material.STONE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + stone);
		}
		else if (block == Material.DEEPSLATE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + deepslate);
		}
		else if (block == Material.DIORITE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + diorite);
		}
		else if (block == Material.ANDESITE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + andesite);
		}
		else if (block == Material.GRANITE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + granite);
		}
		else if (block == Material.COAL_ORE || block == Material.DEEPSLATE_COAL_ORE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + coal);
		}
		else if (block == Material.IRON_ORE || block == Material.DEEPSLATE_IRON_ORE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + iron);
		}
		else if (block == Material.REDSTONE_ORE || block == Material.DEEPSLATE_REDSTONE_ORE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + redstone);
		}
		else if (block == Material.GOLD_ORE || block == Material.DEEPSLATE_GOLD_ORE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + gold);
		}
		else if (block == Material.DIAMOND_ORE || block == Material.DEEPSLATE_DIAMOND_ORE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + diamond);
		}
		else if (block == Material.EMERALD_ORE || block == Material.DEEPSLATE_EMERALD_ORE) {
			Main.plugin.getConfig().set("players." + player.getDisplayName() + ".skills.mining.xp", xp + emerald);
		}
